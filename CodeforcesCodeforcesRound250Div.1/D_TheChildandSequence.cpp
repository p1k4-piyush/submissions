    ...
    while (m--) {
        ...
        if (o == 1) {
            ...
            while (true) {
                ...
                seg.Set(tt.idx, Info(tt.mx % x, tt.idx));
            }
        } else {
            cin >> l >> r;
            seg.Set(l - 1, Info(r, l - 1));
        }
    }
...
// time-limit: 4000
// problem-url: https://codeforces.com/contest/438/problem/D
