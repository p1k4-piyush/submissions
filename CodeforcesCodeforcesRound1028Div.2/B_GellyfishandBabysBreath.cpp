...
void evermore()
{
    ...
    pair<ll, ll> mx1 = { p[0], 0 };
    pair<ll, ll> mx2 = { q[0], 0 };
    ...
    for (int i = 0; i < n; i++) {
        ...
        tt1 = i - mx1.second;
        tt2 = i - mx2.second;
        pair<ll, ll> t = max(make_pair(mx1.first, q[tt1]), make_pair(mx2.first, p[tt2]));
        cout << power(Mint(2), t.first) + power(Mint(2), t.second) << " ";
    }
