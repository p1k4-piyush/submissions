...
void evermore(){
    ...
    while(q--){
        cin >> l >> r;
        l--;
        int t = seg.Query(l,r).cur;
        auto it = lower_bound(s.begin(),s.end(),make_pair(t,l));
        auto itt = lower_bound(s.begin(),s.end(),make_pair(t,r));
...
// time-limit: 1000
// problem-url: https://codeforces.com/contest/474/problem/F
